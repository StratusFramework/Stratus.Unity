...
{
	// TODO: Use the new IStratusLogger
	/// <summary>
	...
	public static class StratusDebug
	{
		...
		public static void Dialog(string title, string message, string ok = "OK", Action onOk = null)
		{
#if UNITY_EDITOR
		...
		/// <param name="onOk"></param>
		public static void Dialog(string title, string message, string ok, string cancel, Action onOk = null)
		{
#if UNITY_EDITOR
