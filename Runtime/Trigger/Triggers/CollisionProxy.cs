...
namespace Stratus.Unity.Triggers
{
	...
	public class CollisionProxy : StratusProxy
	{
		/// <summary>
		...
		/// </summary>
		public static CollisionProxy Construct(Arguments arguments)
		{
			var proxy = arguments.target.gameObject.AddComponent<CollisionProxy>();
