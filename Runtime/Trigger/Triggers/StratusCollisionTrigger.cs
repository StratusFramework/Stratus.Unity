...
namespace Stratus
{
	...
	/// given specified tag.
	/// </summary>
	public class StratusCollisionTrigger : StratusTriggerBehaviour
	{
		//--------------------------------------------------------------------------------------------/
		// Fields
		//--------------------------------------------------------------------------------------------/
		...
		{
			proxy = StratusCollisionProxy.Construct(new StratusCollisionProxy.Arguments(source, type, OnTrigger, OnCollision)
			{
