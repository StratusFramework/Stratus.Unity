...
namespace Stratus.Unity.Triggers
{
	/// <summary>
	/// </summary>
	public class ToggleTriggerable : TriggerableBehaviour
	{
		public enum Scope
		{
			GameObject,
		...
		[DrawIf(nameof(ToggleTriggerable.scope), Scope.GameObject, ComparisonType.Equals)]
		public GameObject target;

		[Tooltip("The Component being enabled")]
		[DrawIf(nameof(ToggleTriggerable.scope), Scope.Behaviour, ComparisonType.Equals)]
