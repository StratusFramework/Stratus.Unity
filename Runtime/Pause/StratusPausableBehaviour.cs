...
namespace Stratus
{
	...
	/// </summary>
	public abstract class StratusPausableBehaviour : StratusBehaviour
	{
		//------------------------------------------------------------------------/
		// Definitions
		//------------------------------------------------------------------------/
		public class ComponentState<ComponentType, State> where ComponentType 
			: Component where State : struct
		{
		...
		protected void Pause(bool paused)
		{
			...
			StratusPausableBehaviour.paused = paused;
			bool enabled = !paused;
		...
		/// </summary>
		private void RegisterPausableComponents()
		{
		...
		/// </summary>
		/// <param name="paused"></param>
		private void ToggleBehaviours(bool enabled)
		{
		...
		/// </summary>
		/// <param name="paused"></param>
		private void ToggleRigidBodies(bool enabled)
		{
		...
		/// </summary>
		/// <param name="paused"></param>
		private void ToggleParticleSystems(bool paused)
		{
			for (var i = 0; i < particleSystems.Length; ++i)
			{
				var particle = particleSystems[i];
