...
{
	public abstract class AssetCollectionScriptable<T> : StratusScriptable<List<T>>,
	...
	public abstract class UnityAssetCollectionScriptable<T> :
		AssetCollectionScriptable<T>
