...
//{
//	[Serializable]
//	public class StratusMemberSetterField
//	{
...
//		[SerializeField]
//		[Filter(typeof(int), Fields = true, Properties = true, Inherited = true)]
//		private UnityMember intValueDynamic;

//		[SerializeField]
//		private float floatValueStatic;
//		[SerializeField]
//		[Filter(typeof(float), Fields = true, Properties = true, Inherited = true)]
//		private UnityMember floatValueDynamic;

//		[SerializeField]
//		private bool boolValueStatic;
//		[SerializeField]
//		[Filter(typeof(bool), Fields = true, Properties = true, Inherited = true)]
//		private UnityMember boolValueDynamic;

//		[SerializeField]
//		private Vector2 vector2ValueStatic;
//		[SerializeField]
//		[Filter(typeof(Vector2), Fields = true, Properties = true, Inherited = true)]
//		private UnityMember vector2ValueDynamic;

//		[SerializeField]
//		private Vector3 vector3ValueStatic;
//		[SerializeField]
//		[Filter(typeof(Vector3), Fields = true, Properties = true, Inherited = true)]
//		private UnityMember vector3ValueDynamic;

//		[SerializeField]
//		private Vector4 vector4ValueStatic;
//		[SerializeField]
//		[Filter(typeof(Vector4), Fields = true, Properties = true, Inherited = true)]
//		private UnityMember vector4ValueDynamic;

//		[SerializeField]
//		private Color colorValueStatic = Color.white;
//		[SerializeField]
//		[Filter(typeof(Color), Fields = true, Properties = true, Inherited = true)]
...
//		private static Dictionary<StratusMemberSetterField, int> instances;
