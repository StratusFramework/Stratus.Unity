...
namespace Stratus.Editor
{
	...
	/// </summary>
	[InitializeOnLoad]
	public class StratusInputManagerUtility
	{
		//------------------------------------------------------------------------/
		// Properties
		//------------------------------------------------------------------------/  
		...
		// CTOR
		//------------------------------------------------------------------------/  
		static StratusInputManagerUtility()
		{
			Object inputManager = AssetDatabase.LoadAllAssetsAtPath(StratusInputManagerUtility.inputManagerPath)[0];
		...
		private static void ReadAxes(SerializedObject inputManagerSerializedObject)
		{
			...
			StratusInputManagerUtility.axesNames = axisList.ToArray();
		}
