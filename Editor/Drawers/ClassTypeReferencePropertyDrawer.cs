...
namespace Stratus.Dependencies.TypeReferences
{
	...
	public sealed class ClassTypeReferencePropertyDrawer : PropertyDrawer
	{
		...
		private static void FilterTypes(IEnumerable<Type> types, ClassTypeConstraintAttribute filter, ICollection<Type> excludedTypes, List<Type> output)
		{
		...
		{
			DrawTypeSelectionControl(position, property.FindPropertyRelative("_classRef"), label, this.attribute as ClassTypeConstraintAttribute);
		}
