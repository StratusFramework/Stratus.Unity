...
namespace Stratus.Unity.Editor
{
	public static class GenericMenuExtensions
	{
		...
		/// <param name="menu"></param>
		/// <param name="property"></param>
		public static void AddPopup(this GenericMenu menu, string label, string[] displayedOptions, Action<int> onSelected)
		{
		...
		public static void AddItems(this GenericMenu menu, string[] displayedOptions, Action<int> onSelected)
		{
			for (int i = 0; i < displayedOptions.Length; ++i)
			{
				int index = i;
