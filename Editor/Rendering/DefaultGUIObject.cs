...
namespace Stratus.Unity.Editor
{
	...
	/// </summary>
	public struct DefaultGUIObject
	{
		//------------------------------------------------------------------------/
		// Properties
		//------------------------------------------------------------------------/
		...
		/// </summary>
		private Dictionary<KeyCode, Action> keyMap { get; set; }  // = new Dictionary<KeyCode, System.Action>();
		/// <summary>
		...
		public bool Draw(GUIStyle style = null, params GUILayoutOption[] options)
		{
			...
			if (backgroundColor != default) GUI.backgroundColor = backgroundColor;
			{
		...
		public void AddKey(KeyCode key, Action onKey)
		{
			if (keyMap == null)
