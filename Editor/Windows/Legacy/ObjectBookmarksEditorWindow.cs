...
namespace Stratus.Unity.Editor
{
	...
	/// </summary>
	public class ObjectBookmarksEditorWindow : EditorWindow
	{
		//------------------------------------------------------------------------/
		// Declaration
		//------------------------------------------------------------------------/
		...
		{
			instance = (ObjectBookmarksEditorWindow)GetWindow(typeof(ObjectBookmarksEditorWindow), false, "Bookmarks");
		}
		...
		private void ShowProjectAssets()
		{
			for (int b = 0; b < bookmarks.projectBookmarks.Count; ++b)
			{
				...
				{
					GameObject instantiated = (GameObject)Instantiate(currentObject);
