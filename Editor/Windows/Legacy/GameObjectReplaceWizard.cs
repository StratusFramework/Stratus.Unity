...
namespace Stratus.Unity.Editor
{
	...
	public class GameObjectReplaceWizard : EditorWindow
	{
		...
		{
			GetWindow(typeof(GameObjectReplaceWizard), true, "GameObject Replace Wizard");
		}

		public static void Open(GameObject[] selectedObjs)
		{
			var window = GetWindow(typeof(GameObjectReplaceWizard), true, "GameObject Replace Wizard") as GameObjectReplaceWizard;
