...
namespace Stratus.Editor
{
	...
	/// </summary>
	public class StratusObjectBookmarksEditorWindow : EditorWindow
	{
		//------------------------------------------------------------------------/
		// Declaration
		//------------------------------------------------------------------------/
		...
		private static StratusObjectBookmarksEditorWindow instance { get; set; }
		...
		{
			instance = (StratusObjectBookmarksEditorWindow)EditorWindow.GetWindow(typeof(StratusObjectBookmarksEditorWindow), false, "Bookmarks");
		}
