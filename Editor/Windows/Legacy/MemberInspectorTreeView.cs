...
namespace Stratus.Unity.Editor
{
	...
	public class MemberInspectorTreeView : StratusMultiColumnTreeView<MemberInspectorTreeElement, MemberInspectorWindow.Column>
	{
			...
			switch (columnType)
			{
				case MemberInspectorWindow.Column.Watch:
					column = new TreeViewColumn
					{
						...
						selectorFunction = (element) => watchList.Contains(element.element.data).ToString()
					};
					break;
				case MemberInspectorWindow.Column.GameObject:
					column = new TreeViewColumn
					{
						...
						selectorFunction = (element) => element.element.data.gameObjectName
					};
					break;
				case MemberInspectorWindow.Column.Component:
					column = new TreeViewColumn
					{
						...
						autoResize = false,
						allowToggleVisibility = true,
						selectorFunction = (element) => element.element.data.componentName
					};
					break;
				case MemberInspectorWindow.Column.Type:
					column = new TreeViewColumn
					{
						...
						autoResize = false,
						allowToggleVisibility = true,
						selectorFunction = (element) => element.element.data.typeName
					};
					break;
				...
				case MemberInspectorWindow.Column.Value:
					column = new TreeViewColumn
					{
						...
						autoResize = true,
						allowToggleVisibility = false,
						selectorFunction = (element) => element.element.data.latestValueString
					};
					break;
			}
			return column;
		...
		protected override MemberInspectorWindow.Column GetColumn(int index)
		{
			return (MemberInspectorWindow.Column)index;
		}

		protected override int GetColumnIndex(MemberInspectorWindow.Column columnType)
		{
		...
		protected override void OnItemDoubleClicked(MemberInspectorTreeElement element)
		{
