...
{
	/// <summary>
	/// An editor tool that allows a GameObject (or several)  to be replaceed in the scene hierarchy to be replaced
	/// by another GameObject in the scene (or a prefab)
	/// </summary>  
	public class StratusGameObjectReplaceWizard : EditorWindow
	{
		//------------------------------------------------------------------------/
		// Fields
		//------------------------------------------------------------------------/    
		...
		// Menu, Hierarchy
		//------------------------------------------------------------------------/
		[MenuItem("Stratus/Core/GameObject Replace")]
		private static void Open()
		{
			EditorWindow.GetWindow(typeof(StratusGameObjectReplaceWizard), true, "GameObject Replace Wizard");
		}

		public static void Open(GameObject[] selectedObjs)
		{
			var window = EditorWindow.GetWindow(typeof(StratusGameObjectReplaceWizard), true, "GameObject Replace Wizard") as StratusGameObjectReplaceWizard;
		...
		private static void ReplaceSelected(GameObject[] originals, GameObject prefab, bool keepNames, bool respectHierarchy, bool verbose = false)
		{
			...
			Undo.SetCurrentGroupName(typeof(StratusGameObjectReplaceWizard).Name);
