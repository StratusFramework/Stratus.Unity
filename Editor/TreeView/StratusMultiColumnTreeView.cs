...
namespace Stratus.Editor
{
		...
		where ColumnType : Enum
	{
		...
		// CTOR
		//------------------------------------------------------------------------/
		public StratusMultiColumnTreeView(TreeViewState state, ValueProvider<IList<TreeElementType>> data)
		...
		public StratusMultiColumnTreeView(TreeViewState state, IEnumerable<TreeElementType> data)
			: this(state, new ValueProvider<IList<TreeElementType>>(data.ToList()))
		{
		}
